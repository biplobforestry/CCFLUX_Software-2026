...
rem refused. The offer is written inline because a failure inside a CALLed
...
echo https://www.python.org/downloads/windows/ and run this BAT file again.
...
echo Close this window, open a new one, and run this BAT file again so that the
...
echo Install it from https://www.python.org/downloads/windows/, selecting
echo "Add Python to PATH", then run this BAT file again.
